...
public static class Constants
{
  ...
  public const int MassiveMeasurementCount =
    10000 / DefaultDbFuzzCount / 2;

  public const int MeasurementCount =
    1000 / DefaultDbFuzzCount / 2;

  public const int AggregateCount =
    MeasurementCount / 10;

  public const int MeasurementCountFew =
    MeasurementCount / 4;

  public const int AggregateCountFew =
