...
public class DiscriminatorColumnSpecimenBuilder(DbContext dbContext)
  : ISpecimenBuilder
{
  private readonly Lazy<HashSet<MemberInfo>> discriminatorColumns = new(
    dbContext.GetDiscriminatorColumns
  );

  public object Create(object request, ISpecimenContext context)
  {
    if (
      request is MemberInfo discriminatorColumn
