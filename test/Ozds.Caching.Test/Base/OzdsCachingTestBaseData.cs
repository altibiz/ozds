...
public partial class OzdsCachingTestBase
{
  ...
  public IEnumerable<CompositeEntityWithDependency> CompositeEntitiesWithDependency()
  {
    yield return new CompositeEntityWithDependency<
      ApiKeyAuthEntity,
      ApiKeyEntity
    >(
    ...
    >(
      (composite, dependency) =>
      {
        dependency.Id = composite
          .Scopes.First(x => x is not MeasurementScopeEntity)
          .Id;
      },
      composite => composite.Scopes.First(x => x is not MeasurementScopeEntity)
    );
    yield return new CompositeEntityWithDependency<
      ApiKeyAuthEntity,
    ...
    >(
      ...
      {
        dependency.Id = composite
          .Scopes.First(x => x is MeasurementScopeEntity)
          .Id;
      },
      composite =>
        (
          composite.Scopes.First(x => x is MeasurementScopeEntity)
  ...
  public IEnumerable<CompositeEntityWithIndirectDependency> CompositeEntitiesWithIndirectDependency()
  {
    yield return new CompositeEntityWithIndirectDependency<
      ApiKeyAuthEntity,
      ApiKeyScopeEntity
    >(
      (composite, dependency) =>
  ...
  public sealed record CompositeEntityWithIndirectDependency<
    TComposite,
    TIndirectDependency
  >(
