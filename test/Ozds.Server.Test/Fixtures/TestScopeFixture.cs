...
public class TestScopeFixture(ServiceComposition composition)
{
  public async Task<MeasurementScopeWithRegisters> CreateMeasurementForLocationWithRegisters(
  ...
  )
  {
    ...
    var scope = await trackableFixture.Create<MeasurementScopeModel>(
      ...
      x =>
      {
        x.ScopeModelType = modelReflector.ResolveModelName(
    ...
    var registers = await Task.WhenAll(
      testRegisters.Select(async testRegister =>
      {
        return await trackableFixture.Create<RegisterModel>(
          cancellationToken,
          register =>
          {
    ...
    return new MeasurementScopeWithRegisters(registers.ToList(), scope);
  }

  public async Task<MeasurementScopeWithRegisters> CreateMeasurementForNetworkUserWithRegisters(
  ...
  public async Task<MeasurementScopeWithRegisters> CreateMeasurementForMeasurementLocationWithRegisters(
  ...
  {
    public Action<TestMeasurementLocationFixture.Configurator> ConfigureMeasurementLocation
    {
      get;
      private set;
    } = _ => { };
...
{
  public static readonly TestRegister CurrentL1AnyT0_A = new(
    "current_l1_any_t0_a",
  ...
  public static readonly TestRegister CurrentL2AnyT0_A = new(
    "current_l2_any_t0_a",
    MeasureModel.Current,
    default,
    TariffModel.T0,
  ...
  public static readonly TestRegister CurrentL3AnyT0_A = new(
    "current_l3_any_t0_a",
    MeasureModel.Current,
    default,
    TariffModel.T0,
  ...
  public static readonly TestRegister VoltageL1AnyT0_V = new(
    "voltage_l1_any_t0_v",
  ...
  public static readonly TestRegister VoltageL2AnyT0_V = new(
    "voltage_l2_any_t0_v",
    MeasureModel.Voltage,
    default,
    TariffModel.T0,
  ...
  public static readonly TestRegister VoltageL3AnyT0_V = new(
    "voltage_l3_any_t0_v",
    MeasureModel.Voltage,
    default,
    TariffModel.T0,
  ...
  public static readonly TestRegister ActivePowerL1NetT0_W = new(
  ...
  public static readonly TestRegister ActivePowerL2NetT0_W = new(
  ...
  public static readonly TestRegister ActivePowerL3NetT0_W = new(
  ...
  public static readonly TestRegister ReactivePowerTotalNetT0_VAR = new(
  ...
  public static readonly TestRegister ApparentPowerTotalNetT0_VA = new(
  ...
  public static readonly TestRegister ActiveEnergyL1ImportT0_Wh = new(
  ...
  public static readonly TestRegister ActiveEnergyL2ImportT0_Wh = new(
  ...
  public static readonly TestRegister ActiveEnergyL3ImportT0_Wh = new(
  ...
  public static readonly TestRegister ActiveEnergyTotalImportT0_Wh = new(
  ...
  public static readonly TestRegister ActiveEnergyTotalExportT0_Wh = new(
  ...
  public static readonly TestRegister ReactiveEnergyTotalImportT0_VARh = new(
  ...
  public static readonly TestRegister ReactiveEnergyTotalExportT0_VARh = new(
  ...
  public static readonly TestRegister ActiveEnergyTotalImportT1_Wh = new(
  ...
  public static readonly TestRegister ActiveEnergyTotalImportT2_Wh = new(
  ...
  public static readonly IReadOnlyCollection<TestRegister> SchneideriEM3xxxSet =
