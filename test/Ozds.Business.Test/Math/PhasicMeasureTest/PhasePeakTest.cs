...
{
  public static readonly TheoryData<PhasicMeasure<decimal>> PhasicMeasuresPeakSix = new()
  {
  ...
  public static readonly TheoryData<PhasicMeasure<decimal>> PhasicMeasuresPeakZero = new()
  {
