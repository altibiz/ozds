...
public class ConvertPrimitiveToFloatTest
{
  public static readonly
    ...
    SpanningMeasuresConvertToFloat = new()
    {
      ...
      {
        new AvgSpanningMeasure<decimal>(new UnaryTariffMeasure<decimal>(
          new ImportExportDuplexMeasure<decimal>(
            new TriPhasicMeasure<decimal>(1, 2, 3),
            new TriPhasicMeasure<decimal>(4, 5, 6)))),
        new AvgSpanningMeasure<float>(new UnaryTariffMeasure<float>(
...

      {
        ...
        new PeakSpanningMeasure<float>(new UnaryTariffMeasure<float>(
          new ImportExportDuplexMeasure<float>(
  ...
  public void ConvertPrimitiveToFloat_ReturnsExpectedResult(
    SpanningMeasure<decimal> measure, SpanningMeasure<float> expected)
  {
