...
{
  public static readonly TheoryData<SpanningMeasure<decimal>, TariffMeasure<decimal>> SpanningMeasuresAvg = new()
  {
    { new AvgSpanningMeasure<decimal>(new UnaryTariffMeasure<decimal>(new ImportExportDuplexMeasure<decimal>(new SinglePhasicMeasure<decimal>(5), new SinglePhasicMeasure<decimal>(3)))),
  ...
  public void SpanAvg_ReturnsExpectedResult(SpanningMeasure<decimal> measure, TariffMeasure<decimal> expected)
  {
