...
{
  public static readonly TheoryData<TariffMeasure<decimal>, DuplexMeasure<decimal>> TariffMeasuresUnary = new()
  {
  ...
  public void TariffUnary_ReturnsExpectedResult(TariffMeasure<decimal> measure, DuplexMeasure<decimal> expected)
  {
