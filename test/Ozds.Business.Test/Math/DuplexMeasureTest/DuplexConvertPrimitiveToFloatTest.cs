...
{
  public static readonly TheoryData<DuplexMeasure<decimal>, DuplexMeasure<float>> DuplexMeasuresConvertToFloat = new()
  {
    { new ImportExportDuplexMeasure<decimal>(new SinglePhasicMeasure<decimal>(5), new SinglePhasicMeasure<decimal>(3)),
      new ImportExportDuplexMeasure<float>(new SinglePhasicMeasure<float>(5f), new SinglePhasicMeasure<float>(3f)) },
  ...
  public void ConvertPrimitiveToFloatReturnsExpectedResult(DuplexMeasure<decimal> measure, DuplexMeasure<float> expected)
  {
