...
{
  public static readonly TheoryData<DuplexMeasure<decimal>, decimal, DuplexMeasure<decimal>> DuplexMeasuresDivide = new()
  {
    { new ImportExportDuplexMeasure<decimal>(new SinglePhasicMeasure<decimal>(10), new SinglePhasicMeasure<decimal>(6)), 2,
      new ImportExportDuplexMeasure<decimal>(new SinglePhasicMeasure<decimal>(5), new SinglePhasicMeasure<decimal>(3)) },

    { new ImportExportDuplexMeasure<decimal>(new TriPhasicMeasure<decimal>(8, 6, 4), new TriPhasicMeasure<decimal>(2, 1, 0.5m)), 2,
      new ImportExportDuplexMeasure<decimal>(new TriPhasicMeasure<decimal>(4, 3, 2), new TriPhasicMeasure<decimal>(1, 0.5m, 0.25m)) },
  ...
  public void DivideReturnsExpectedResult(DuplexMeasure<decimal> measure, decimal divisor, DuplexMeasure<decimal> expected)
  {
