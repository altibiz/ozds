...
{
  public static IEnumerable<SupplyRenewableEnergyCalculationItemModel> TestData()
  {
  ...
  )
  {
    ...
    var calculator = new SupplyRenewableEnergyCalculationItemCalculator();
    var actual = calculator.Calculate(input);

    actual
      .Should()
      .BeOfType<SupplyRenewableEnergyCalculationItemModel>()
