...
{
  public static IEnumerable<UsageActiveEnergyTotalImportT2CalculationItemModel> TestData()
  {
  ...
  public void CalculatesCorrectlyWithFuzzyAbbB2xAggregates(
    UsageActiveEnergyTotalImportT2CalculationItemModel expected
  )
  {
    ...
    var calculator =
      new UsageActiveEnergyTotalImportT2CalculationItemCalculator();
    var actual = calculator.Calculate(input);

    actual
      .Should()
      .BeOfType<UsageActiveEnergyTotalImportT2CalculationItemModel>()
