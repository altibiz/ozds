...
public class UsageActiveEnergyTotalImportT2CalculationItemCalculatorTest
{
  public static readonly
    TheoryData<UsageActiveEnergyTotalImportT2CalculationItemModel>
    TestData = new(
      new Faker<UsageActiveEnergyTotalImportT2CalculationItemModel>()
        .RuleFor(
          x => x.Min_kWh,
    ...
    UsageActiveEnergyTotalImportT2CalculationItemModel expected)
  {
    ...
    var startAggregate =
      new Faker<AbbB2xAggregateModel>()
        ...
        .RuleFor(x => x.ActiveEnergyTotalExportT0_Wh, f => measureFakerNoise.Generate())
        .RuleFor(x => x.ActiveEnergyTotalImportT1_Wh, f => measureFakerNoise.Generate())
        .RuleFor(x => x.ActiveEnergyTotalImportT2_Wh, f => measureFakerStart.Generate())
        .Generate();
    ...
    var endAggregate =
      new Faker<AbbB2xAggregateModel>()
        ...
        .RuleFor(x => x.ActiveEnergyTotalExportT0_Wh, f => measureFakerNoise.Generate())
        .RuleFor(x => x.ActiveEnergyTotalImportT1_Wh, f => measureFakerNoise.Generate())
        .RuleFor(x => x.ActiveEnergyTotalImportT2_Wh, f => measureFakerEnd.Generate())
        .Generate();
    ...
    actual.Should()
      .BeOfType<UsageActiveEnergyTotalImportT2CalculationItemModel>().And
