...
{
  public static IEnumerable<UsageMeterFeeCalculationItemModel> TestData()
  {
  ...
  )
  {
    ...
    var calculator = new UsageMeterFeeCalculationItemCalculator();
    var actual = calculator.Calculate(input);

    actual
      .Should()
      .BeOfType<UsageMeterFeeCalculationItemModel>()
