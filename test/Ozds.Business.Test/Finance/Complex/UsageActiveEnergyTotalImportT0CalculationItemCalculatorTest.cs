...
{
  public static IEnumerable<UsageActiveEnergyTotalImportT0CalculationItemModel> TestData()
  {
  ...
  public void CalculatesCorrectlyWithFuzzyAbbB2xAggregates(
    UsageActiveEnergyTotalImportT0CalculationItemModel expected
  )
  {
    ...
    actual
      .Should()
      .BeOfType<UsageActiveEnergyTotalImportT0CalculationItemModel>()
