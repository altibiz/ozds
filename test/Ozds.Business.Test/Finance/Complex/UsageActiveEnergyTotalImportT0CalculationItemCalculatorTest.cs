...
public class UsageActiveEnergyTotalImportT0CalculationItemCalculatorTest
{
  public static readonly
    TheoryData<UsageActiveEnergyTotalImportT0CalculationItemModel>
    TestData = new(
      new Faker<UsageActiveEnergyTotalImportT0CalculationItemModel>()
        .RuleFor(
          x => x.Min_kWh,
    ...
    UsageActiveEnergyTotalImportT0CalculationItemModel expected)
  {
    ...
    var endAggregate =
      new Faker<AbbB2xAggregateModel>()
        ...
        .RuleFor(
          x => x.ActiveEnergyL3ImportT0_Wh, f => measureFakerNoise.Generate())
        .RuleFor(
          x => x.ActiveEnergyTotalImportT0_Wh, f => measureFakerEnd.Generate())
        .RuleFor(
          x => x.ActiveEnergyL1ExportT0_Wh, f => measureFakerNoise.Generate())
        .RuleFor(
          x => x.ActiveEnergyL2ExportT0_Wh, f => measureFakerNoise.Generate())
    ...
    actual.Should()
      .BeOfType<UsageActiveEnergyTotalImportT0CalculationItemModel>().And
