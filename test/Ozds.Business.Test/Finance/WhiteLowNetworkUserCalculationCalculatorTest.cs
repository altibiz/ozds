...
public class WhiteLowNetworkUserCalculationCalculatorTest
{
  public static IEnumerable<WhiteLowNetworkUserCalculationModel> TestData()
  {
    return new Fixture()
      .Customize(
        new TypeRelay(
  ...
  {
    var calculationItemCalculatorMock = new Mock<CalculationItemCalculator>(
      MockBehavior.Strict,
    ...
    var calculator = new WhiteLowNetworkUserCalculationCalculator(
    ...
    var fixture = new Fixture()
      ...
      .Customize(
        new TypeRelay(
          ...
          typeof(WhiteLowNetworkUserCatalogueModel)
        ).ToCustomization()
      )
      .Customize(
        new TypeRelay(
    ...
    actual
      .Should()
      .BeOfType<WhiteLowNetworkUserCalculationModel>()
      .And.BeEquivalentTo(
        expected,
        c =>
          c.Excluding(x => x.Id)
