...
public class WhiteMediumNetworkUserCalculationCalculatorTest
{
  public static IEnumerable<WhiteMediumNetworkUserCalculationModel> TestData()
  {
    return new Fixture()
      .Customize(
        new TypeRelay(
  ...
  )
  {
    ...
    var fixture = new Fixture()
      ...
      .Customize(
        new TypeRelay(
          ...
          typeof(WhiteMediumNetworkUserCatalogueModel)
        ).ToCustomization()
      )
      .Customize(
        new TypeRelay(
    ...
    actual
      .Should()
      .BeOfType<WhiteMediumNetworkUserCalculationModel>()
      .And.BeEquivalentTo(
        expected,
        c =>
          c.Excluding(x => x.Id)
