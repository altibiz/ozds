...
) : InheritingModelFaker<SchneideriEM3xxxMeasurementValidatorModel, MeasurementValidatorModel>(serviceProvider)
{
  public override void Initialize(SchneideriEM3xxxMeasurementValidatorModel model, Faker faker)
  {
    ...
    model.MaxActivePower_W = faker.Random.Decimal(model.MinActivePower_W, 1000 * 10);
    model.MinReactivePower_VAR = faker.Random.Decimal(0, 1000);
    model.MaxReactivePower_VAR = faker.Random.Decimal(model.MinReactivePower_VAR, 1000 * 10);
    model.MinApparentPower_VA = faker.Random.Decimal(0, 1000);
    model.MaxApparentPower_VA = faker.Random.Decimal(model.MinApparentPower_VA, 1000 * 10);
  }
}
