  ...
  : MassTransitStateMachine<NetworkUserInvoiceStateEntity>
{
  public NetworkUserInvoiceStateMachine()
  {
    ...
    Initially(When(InitiateNetworkUserInvoice).TransitionTo(Initiated));
    ...
    During(
      ...
      When(ApproveNetworkUserInvoice)
        .IfElse(
          ...
          x =>
            x.Then(context => context.Saga.Approved = true)
  ...
  public Event<IInitiateNetworkUserInvoice> InitiateNetworkUserInvoice { get; } =
    default!;

  public Event<IAbortNetworkUserInvoice> AbortNetworkUserInvoice { get; } =
    default!;

  public Event<IRegisterNetworkUserInvoice> RegisterNetworkUserInvoice { get; } =
    default!;
