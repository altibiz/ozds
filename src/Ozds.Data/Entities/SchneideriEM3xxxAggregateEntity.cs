...
public class SchneideriEM3xxxAggregateEntityProcedureParts
  : MeasurementProcedureParts<SchneideriEM3xxxAggregateEntity>
{
  protected override void Configure(
    MeasurementProcedureBuilder<SchneideriEM3xxxAggregateEntity> builder
  )
  {
    builder
      ...
      .InstantaneousAggregateMeasure(x => x.ReactivePowerTotalNetT0_VAR)
      .InstantaneousAggregateMeasure(x => x.ApparentPowerTotalNetT0_VA)
