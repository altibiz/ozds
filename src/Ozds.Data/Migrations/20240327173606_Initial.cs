        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    catalogue_entity_id = table.Column<string>(type: "text", nullable: true),
                    location_entity_id = table.Column<string>(type: "text", nullable: true),
                    measurement_location_entity_id = table.Column<string>(type: "text", nullable: true),
                    measurement_validator_entity_id = table.Column<string>(type: "text", nullable: true),
                    messenger_entity_id = table.Column<string>(type: "text", nullable: true),
                    meter_entity_id = table.Column<string>(type: "text", nullable: true),
                    network_user_entity_id = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_events_representatives_representative_entity_id",
                        column: x => x.representative_entity_id,
                        principalTable: "representatives",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "text", nullable: false),
                    measurement_location_id = table.Column<string>(type: "text", nullable: false),
                    white_medium_catalogue_id = table.Column<string>(type: "text", nullable: false),
                    blue_low_catalogue_id = table.Column<string>(type: "text", nullable: false),
                    white_low_catalogue_id = table.Column<string>(type: "text", nullable: false),
                    red_low_catalogue_id = table.Column<string>(type: "text", nullable: false),
                    regulatory_catalogue_id = table.Column<string>(type: "text", nullable: false),
                    title = table.Column<string>(type: "text", nullable: false),
                    created_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    created_by_id = table.Column<string>(type: "text", nullable: true),
                    last_updated_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<string>(type: "text", nullable: false),
                    network_user_id = table.Column<string>(type: "text", nullable: false),
                    issued_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    issued_by_id = table.Column<string>(type: "text", nullable: true),
                    from_date = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    to_date = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    network_user_id = table.Column<string>(type: "text", nullable: true),
                    title = table.Column<string>(type: "text", nullable: false),
                    created_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    created_by_id = table.Column<string>(type: "text", nullable: true),
                    last_updated_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    kind = table.Column<string>(type: "character varying(34)", maxLength: 34, nullable: false),
                    measurement_validator_id = table.Column<string>(type: "text", nullable: true),
                    schneideri_em3xxx_meter_entity_measurement_validator_id = table.Column<string>(type: "text", nullable: true),
                    title = table.Column<string>(type: "text", nullable: false),
                    created_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    created_by_id = table.Column<string>(type: "text", nullable: true),
                    last_updated_on = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_meters_catalogues_catalogue_id",
                        column: x => x.catalogue_id,
                        principalTable: "catalogues",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_meters_measurement_locations_measurement_location_id",
                        column: x => x.measurement_location_id,
                        principalTable: "measurement_locations",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_meters_measurement_validators_measurement_validator_id",
                        column: x => x.measurement_validator_id,
                        principalTable: "measurement_validators",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_meters_measurement_validators_measurement_validator_id1",
                        column: x => x.schneideri_em3xxx_meter_entity_measurement_validator_id,
                        principalTable: "measurement_validators",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_events_messenger_entity_id",
                table: "events",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_events_meter_entity_id",
                table: "events",
                column: "meter_entity_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_events_representative_entity_id",
                table: "events",
                column: "representative_entity_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_location_invoices_location_id",
                table: "location_invoices",
                column: "location_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_locations_measurement_location_id",
                table: "locations",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_measurement_locations_meter_id",
                table: "measurement_locations",
                column: "meter_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_measurement_validators_meter_id",
                table: "measurement_validators",
                column: "meter_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_messengers_location_id",
                table: "messengers",
                column: "location_id");

            migrationBuilder.CreateIndex(
                name: "ix_meters_catalogue_id",
                table: "meters",
                column: "catalogue_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_meters_measurement_location_id",
                table: "meters",
                column: "measurement_location_id");

            migrationBuilder.CreateIndex(
                name: "ix_meters_measurement_validator_id",
                table: "meters",
                column: "measurement_validator_id");

            migrationBuilder.CreateIndex(
                name: "ix_meters_measurement_validator_id1",
                table: "meters",
                column: "schneideri_em3xxx_meter_entity_measurement_validator_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_network_user_invoices_network_user_id",
                table: "network_user_invoices",
                column: "network_user_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_network_users_location_id",
                table: "network_users",
                column: "location_id");
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_events_messengers_messenger_entity_id",
                table: "events",
                column: "messenger_entity_id",
                principalTable: "messengers",
                principalColumn: "id");
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_events_meters_meter_entity_id",
                table: "events",
                column: "meter_entity_id",
                principalTable: "meters",
                principalColumn: "id");
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_locations_measurement_locations_measurement_location_id",
                table: "locations",
                column: "measurement_location_id",
                principalTable: "measurement_locations",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_measurement_validators_meters_meter_id",
                table: "measurement_validators",
                column: "meter_id",
                principalTable: "meters",
                principalColumn: "id",
