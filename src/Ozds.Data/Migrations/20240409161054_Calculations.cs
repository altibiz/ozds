...
namespace Ozds.Data.Migrations
{
    ...
    public partial class Calculations : Migration
    {
        ...
        {
            migrationBuilder.DropForeignKey(name: "fk_meters_catalogues__catalogue_id", table: "meters");

            migrationBuilder.DropForeignKey(name: "fk_meters_messengers_messenger_id", table: "meters");

            migrationBuilder.DropIndex(name: "ix_meters__catalogue_id", table: "meters");

            migrationBuilder.DropColumn(name: "catalogue_id", table: "meters");

            migrationBuilder.DropColumn(name: "max_active_power_total_import_t1_price_eur", table: "catalogues");

            migrationBuilder.DropColumn(name: "reactive_energy_total_import_t0_price_eur", table: "catalogues");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    archived_catalogue_created_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    archived_catalogue_deleted_by_id = table.Column<string>(type: "text", nullable: true),
                    archived_catalogue_deleted_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    archived_catalogue_last_updated_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    archived_measurement_location_created_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    archived_measurement_location_deleted_by_id = table.Column<string>(type: "text", nullable: true),
                    archived_measurement_location_deleted_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    archived_measurement_location_last_updated_by_id = table.Column<string>(
                        type: "text",
                        nullable: true
                    ),
                    archived_measurement_location_last_updated_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    archived_meter_created_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
                    archived_meter_deleted_by_id = table.Column<string>(type: "text", nullable: true),
                    archived_meter_deleted_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    archived_meter_last_updated_on = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    ...
                    reactive_energy_total_import_t0_amount_varh = table.Column<decimal>(
                        type: "numeric",
                        nullable: true
                    ),
                    ...
                    reactive_energy_total_export_t0_amount_varh = table.Column<decimal>(
                        type: "numeric",
                        nullable: true
                    ),
                    reactive_energy_total_ramped_t0amount_va_rh = table.Column<decimal>(
                        type: "numeric",
                        nullable: true
                    ),
                    ...
                    red_low_network_user_calculation_entity_reactive_energy_total_rampe = table.Column<decimal>(
                        name: "red_low_network_user_calculation_entity_reactive_energy_total_rampe~",
                        type: "numeric",
                        nullable: true
                    ),
                    white_low_network_user_calculation_entity_reactive_energy_total_ram = table.Column<decimal>(
                    ...
                    white_medium_network_user_calculation_entity_reactive_energy_total_ = table.Column<decimal>(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "network_user_calculations");

            migrationBuilder.DropIndex(name: "ix_measurement_locations_catalogue_id", table: "measurement_locations");
            ...
            migrationBuilder.DropColumn(name: "archived_location_created_by_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_created_on", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_deleted_by_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_deleted_on", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_is_deleted", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_last_updated_by_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_last_updated_on", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_location_red_low_catalogue_id", table: "network_user_invoices");
            ...
            migrationBuilder.DropColumn(name: "archived_location_title", table: "network_user_invoices");
            ...
            migrationBuilder.DropColumn(name: "archived_network_user_created_by_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_network_user_created_on", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_network_user_deleted_by_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_network_user_deleted_on", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_network_user_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_network_user_is_deleted", table: "network_user_invoices");
            ...
            migrationBuilder.DropColumn(name: "archived_network_user_last_updated_on", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_network_user_location_id", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "archived_network_user_title", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "tax_eur", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "total_eur", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "total_with_tax_eur", table: "network_user_invoices");

            migrationBuilder.DropColumn(name: "catalogue_id", table: "measurement_locations");

            migrationBuilder.DropColumn(name: "archived_location_blue_low_catalogue_id", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_created_by_id", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_created_on", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_deleted_by_id", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_deleted_on", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_id", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_is_deleted", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_last_updated_by_id", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_last_updated_on", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_red_low_catalogue_id", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_regulatory_catalogue_id", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_title", table: "location_invoices");

            migrationBuilder.DropColumn(name: "archived_location_white_low_catalogue_id", table: "location_invoices");
            ...
            migrationBuilder.DropColumn(name: "tax_eur", table: "location_invoices");

            migrationBuilder.DropColumn(name: "total_eur", table: "location_invoices");

            migrationBuilder.DropColumn(name: "total_with_tax_eur", table: "location_invoices");

            migrationBuilder.DropColumn(name: "active_power_total_import_t1_price_eur", table: "catalogues");

            migrationBuilder.DropColumn(name: "reactive_energy_total_ramped_t0_price_eur", table: "catalogues");
            ...
            migrationBuilder.CreateIndex(name: "ix_meters__catalogue_id", table: "meters", column: "catalogue_id");
