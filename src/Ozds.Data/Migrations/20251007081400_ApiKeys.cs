    ...
    public partial class ApiKeys : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder
                ...
                .Annotation(
                    "Npgsql:Enum:measure_entity",
                    "current,voltage,active_power,reactive_power,apparent_power,active_energy,reactive_energy,apparent_energy"
                )
                .Annotation(
                    "Npgsql:Enum:order_of_magnitude_entity",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    order_of_magnitude = table.Column<OrderOfMagnitudeEntity>(
                        type: "order_of_magnitude_entity",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateIndex(name: "ix_api_keys_created_by_id", table: "api_keys", column: "created_by_id");

            migrationBuilder.CreateIndex(name: "ix_api_keys_deleted_by_id", table: "api_keys", column: "deleted_by_id");

            migrationBuilder.CreateIndex(name: "ix_api_keys_expires_on", table: "api_keys", column: "expires_on");
            ...
            migrationBuilder.CreateIndex(name: "ix_registers_scope_id", table: "registers", column: "scope_id");

            migrationBuilder.CreateIndex(name: "ix_scopes_created_by_id", table: "scopes", column: "created_by_id");

            migrationBuilder.CreateIndex(name: "ix_scopes_deleted_by_id", table: "scopes", column: "deleted_by_id");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "api_key_scopes");

            migrationBuilder.DropTable(name: "registers");

            migrationBuilder.DropTable(name: "api_keys");

            migrationBuilder.DropTable(name: "scopes");
            ...
            migrationBuilder.DropColumn(name: "created_by_id", table: "network_user_representatives");

            migrationBuilder.DropColumn(name: "created_on", table: "network_user_representatives");

            migrationBuilder.DropColumn(name: "created_by_id", table: "location_representatives");

            migrationBuilder.DropColumn(name: "created_on", table: "location_representatives");
