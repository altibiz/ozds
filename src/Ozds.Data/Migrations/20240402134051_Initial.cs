    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "pk_location_entity_representative_entity",
                        x => new { x.locations_id, x.representatives_string_id }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "pk_network_user_entity_representative_entity",
                        x => new { x.network_users_id, x.representatives_string_id }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    {
                        table.PrimaryKey(
                            "pk_schneider_iem3xxx_aggregates",
                            x => new
                            {
                                x.timestamp,
                                x.interval,
            ...
            migrationBuilder.CreateIndex(name: "ix_events_messenger_id", table: "events", column: "messenger_id");
            ...
            migrationBuilder.CreateIndex(name: "ix_meters_created_by_id", table: "meters", column: "created_by_id");

            migrationBuilder.CreateIndex(name: "ix_meters_deleted_by_id", table: "meters", column: "deleted_by_id");
            ...
            migrationBuilder.CreateIndex(name: "ix_meters_messenger_id", table: "meters", column: "messenger_id");
        ...
        {
            migrationBuilder.DropTable(name: "abb_b2x_aggregates");

            migrationBuilder.DropTable(name: "abb_b2x_measurements");

            migrationBuilder.DropTable(name: "events");

            migrationBuilder.DropTable(name: "location_entity_representative_entity");

            migrationBuilder.DropTable(name: "location_invoices");

            migrationBuilder.DropTable(name: "measurement_locations");

            migrationBuilder.DropTable(name: "network_user_entity_representative_entity");

            migrationBuilder.DropTable(name: "network_user_invoices");

            migrationBuilder.DropTable(name: "schneider_iem3xxx_aggregates");

            migrationBuilder.DropTable(name: "schneider_iem3xxx_measurements");

            migrationBuilder.DropTable(name: "network_users");

            migrationBuilder.DropTable(name: "meters");

            migrationBuilder.DropTable(name: "measurement_validators");

            migrationBuilder.DropTable(name: "messengers");

            migrationBuilder.DropTable(name: "locations");

            migrationBuilder.DropTable(name: "catalogues");

            migrationBuilder.DropTable(name: "representatives");
        }
    }
}
