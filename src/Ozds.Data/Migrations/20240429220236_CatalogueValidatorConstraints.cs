...
namespace Ozds.Data.Migrations
{
    ...
    public partial class CatalogueValidatorConstraints : Migration
    {
        ...
        {
            migrationBuilder.DropIndex(name: "ix_meters__measurement_validator_id", table: "meters");

            migrationBuilder.DropIndex(name: "ix_locations__blue_low_network_user_catalogue_id", table: "locations");

            migrationBuilder.DropIndex(name: "ix_locations__red_low_network_user_catalogue_id", table: "locations");

            migrationBuilder.DropIndex(name: "ix_locations__regulatory_network_user_catalogue_id", table: "locations");

            migrationBuilder.DropIndex(name: "ix_locations__white_low_network_user_catalogue_id", table: "locations");
