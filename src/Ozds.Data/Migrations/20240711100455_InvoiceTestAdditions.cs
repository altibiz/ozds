...
namespace Ozds.Data.Migrations
{
    ...
    public partial class InvoiceTestAdditions : Migration
    {
        ...
        {
            migrationBuilder.DropColumn(name: "tax_rate_percent", table: "network_user_invoices");
            ...
            migrationBuilder.DropColumn(name: "tax_rate_percent", table: "location_invoices");
