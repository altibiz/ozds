...
namespace Ozds.Sdk.Contracts.V1
{
    ...
    public partial interface IOzdsApiV1Client
    {
        ...
        System.Threading.Tasks.Task<QuarterHourlyAggregatesByLocationResponse> QuarterHourlyAggregatesByLocationAsync(string locationId, System.DateTimeOffset? dateFrom, System.DateTimeOffset? dateTo, int? page);

        /// <returns>OK</returns>
        /// <exception cref="OzdsApiV1Exception">A server side error occurred.</exception>
        QuarterHourlyAggregatesByLocationResponse QuarterHourlyAggregatesByLocation(string locationId, System.DateTimeOffset? dateFrom, System.DateTimeOffset? dateTo, int? page);
    ...
    public partial class QuarterHourlyAggregatesByLocationResponse
    {
        ...
        public System.Collections.Generic.ICollection<QuarterHourlyAggregatesByLocationResponseMeasurement> Measurements { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.6.1.0 (NJsonSchema v11.5.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class OzdsApiV1Exception : System.Exception
    {
        ...
        public OzdsApiV1Exception(string message, int statusCode, string response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, System.Exception innerException)
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.6.1.0 (NJsonSchema v11.5.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class OzdsApiV1Exception<TResult> : OzdsApiV1Exception
    {
        public TResult Result { get; private set; }

        public OzdsApiV1Exception(string message, int statusCode, string response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, TResult result, System.Exception innerException)
