...
public class ActiveEnergyTotalImportT0CalculationItemCalculator :
  CalculationItemCalculator<ActiveEnergyTotalImportT0CalculationItemModel>
{
  protected override ActiveEnergyTotalImportT0CalculationItemModel
