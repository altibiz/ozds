...
public class ReactiveEnergyTotalRampedT0CalculationItemCalculator : CalculationItemCalculator<ReactiveEnergyTotalRampedT0CalculationItemModel>
{
  protected override ReactiveEnergyTotalRampedT0CalculationItemModel CalculateConcrete(CalculationItemBasisModel calculationBasis)
  {
    ...
    var reactiveAmount = new MinMaxSpanningMeasure<decimal>(
      aggregates.FirstOrDefault()!.ReactiveEnergy_VARh.ConvertPrimitiveTo<decimal>(),
      aggregates.LastOrDefault()!.ReactiveEnergy_VARh.ConvertPrimitiveTo<decimal>()
    );
    ...
    return new ReactiveEnergyTotalRampedT0CalculationItemModel
    {
      ...
      ImportAmount_VARh = reactiveAmount.SpanDiff.TariffUnary.DuplexImport.PhaseSum,
      ...
      ExportAmount_VARh = reactiveAmount.SpanDiff.TariffUnary.DuplexExport.PhaseSum,
      Price_EUR = calculationBasis.Price,
      Amount_VARh = rampedAmount.TariffUnary.DuplexAny.PhaseSum,
      Total_EUR = rampedAmount.TariffUnary.DuplexAny.PhaseSum * calculationBasis.Price
    };
  }
}
