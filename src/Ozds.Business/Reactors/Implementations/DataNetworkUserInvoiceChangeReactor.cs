...
public class DataNetworkUserInvoiceChangeReactor(
  ...
  : Reactor<
    ...
    DataNetworkUserInvoiceChangeHandler
  >(serviceProvider) { }
...
) : Handler<DataModelsChangedEventArgs>
{
  ...
  )
  {
    ...
    var invoices = eventArgs
      ...
      .Select(invoice => new AcknowledgeNetworkUserInvoice(
        invoice.Id,
        ...
        [
          new AcknowledgeNetworkUserInvoiceItem(
            localizationQueries.Translate(
              culture,
              "Network usage during one tariff period"
            ),
          ...
          new AcknowledgeNetworkUserInvoiceItem(
            localizationQueries.Translate(
              culture,
              "Network usage during multiple tariff periods"
            ),
            localizationQueries.Translate(culture, "Month"),
            "1.2.",
            1,
          ...
          new AcknowledgeNetworkUserInvoiceItem(
            localizationQueries.Translate(
              culture,
              "Network usage during off-peak tariff period"
            ),
            localizationQueries.Translate(culture, "Month"),
            "1.3.",
            1,
          ...
          new AcknowledgeNetworkUserInvoiceItem(
            localizationQueries.Translate(
              culture,
              "Engaged power during multiple tariff periods"
            ),
            localizationQueries.Translate(culture, "Month"),
            "1.4.",
            1,
          ...
          new AcknowledgeNetworkUserInvoiceItem(
            localizationQueries.Translate(
              culture,
              "Excessively taken reactive power"
            ),
            localizationQueries.Translate(culture, "Month"),
            "1.5.",
            1,
    ...
    logger.LogInformation("Acknowledging invoices: {Count}", invoices.Count);
