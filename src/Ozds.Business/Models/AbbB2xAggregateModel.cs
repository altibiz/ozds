...
{
  [Required]
  public required InstantaneousAggregateMeasureModel VoltageL1AnyT0_V { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel VoltageL2AnyT0_V { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel VoltageL3AnyT0_V { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel CurrentL1AnyT0_A { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel CurrentL2AnyT0_A { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel CurrentL3AnyT0_A { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel ActivePowerL1NetT0_W { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel ActivePowerL2NetT0_W { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel ActivePowerL3NetT0_W { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel ReactivePowerL1NetT0_VAR { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel ReactivePowerL2NetT0_VAR { get; set; } =
    default!;

  [Required]
  public required InstantaneousAggregateMeasureModel ReactivePowerL3NetT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyL1ImportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerL1ImportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyL2ImportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerL2ImportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyL3ImportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerL3ImportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyL1ExportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerL1ExportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyL2ExportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerL2ExportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyL3ExportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerL3ExportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyL1ImportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerL1ImportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyL2ImportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerL2ImportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyL3ImportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerL3ImportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyL1ExportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerL1ExportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyL2ExportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerL2ExportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyL3ExportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerL3ExportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyTotalImportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerTotalImportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyTotalExportT0_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerTotalExportT0_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyTotalImportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerTotalImportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ReactiveEnergyTotalExportT0_VARh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedReactivePowerTotalExportT0_VAR { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyTotalImportT1_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerTotalImportT1_W { get; set; } =
    default!;

  [Required]
  public required CumulativeAggregateMeasureModel ActiveEnergyTotalImportT2_Wh { get; set; } =
    default!;

  [Required]
  public required DerivedAggregateMeasureModel DerivedActivePowerTotalImportT2_W { get; set; } =
    default!;
