...
{
  public static WhiteMediumCatalogueModel ToModel(this WhiteMediumCatalogueEntity entity) =>
    new(
      entity.Id,
      entity.Title,
      entity.CreatedOn,
  ...
  public static WhiteMediumCatalogueEntity ToEntity(this WhiteMediumCatalogueModel model) =>
    new()
    {
      Id = model.Id,
      Title = model.Title,
