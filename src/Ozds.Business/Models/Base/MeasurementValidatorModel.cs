...
public abstract class MeasurementValidatorModel<T> : AuditableModel, IMeasurementValidator
  where T : IMeasurement
{
    ...
    ValidationContext validationContext)
  {
    ...
    {
      foreach (var result in ValidateMeasurement(measurement, validationContext.MemberName))
      {
        yield return result;
      }
    }
