...
public static class IServiceCollectionExtensions
{
  ...
  {
    services.AddDbContextFactory<OzdsDataDbContext>((services, options) =>
    {
      var connectionString = builder.Configuration["Ozds:Data:ConnectionString"]
  ...
  )
  {
    ...
    services.AddDbContext<OzdsMessagingDbContext>(builder => builder
      .UseNpgsql(persistenceConnectionString, m =>
      {
    ...
    services.AddMassTransit(x =>
    {
      ...
      x.SetSagaRepositoryProvider(new OzdsSagaRepositoryRegistrationProvider());
  ...
  private class OzdsSagaRepositoryRegistrationProvider
  ...
  private class HostedServiceModularTenantEvents<THostedService>(
