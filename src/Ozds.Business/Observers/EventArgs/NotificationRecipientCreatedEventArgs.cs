...
{
  public required
    IReadOnlyList<NotificationRecipientsCreatedEventArgsNotificationRecipients>
    NotificationRecipients { get; init; }
}
...
public class NotificationRecipientsCreatedEventArgsNotificationRecipients
{
  ...
  public required IReadOnlyList<NotificationRecipientModel> Recipients
  {
    get;
    init;
  }
