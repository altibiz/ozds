...
public class AbbB2xAggregateModelActivator(IServiceProvider serviceProvider)
  ...
  )
{
  ...
  public override void Initialize(AbbB2xAggregateModel model)
  {
    ...
    model.VoltageL1AnyT0_V =
      modelActivator.Activate<InstantaneousAggregateMeasureModel>();
    ...
    model.ActiveEnergyL1ImportT0_Wh =
      modelActivator.Activate<CumulativeAggregateMeasureModel>();
    model.DerivedActivePowerL1ImportT0_W =
      modelActivator.Activate<DerivedAggregateMeasureModel>();
