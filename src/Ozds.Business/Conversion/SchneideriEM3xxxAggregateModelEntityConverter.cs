...
public static class SchneideriEM3xxxAggregateModelEntityConverterExtensions
{
    ...
    this SchneideriEM3xxxAggregateModel model)
  {
    return new SchneideriEM3xxxAggregateEntity
    {
      ...
      ReactivePowerTotalNetT0Avg_VAR = (float)model.ReactivePowerTotalNetT0Avg_VAR,
      ApparentPowerTotalNetT0Avg_VA = (float)model.ApparentPowerTotalNetT0Avg_VA,
    ...
    this SchneideriEM3xxxAggregateEntity entity)
  {
    return new SchneideriEM3xxxAggregateModel
    {
      ...
      ReactivePowerTotalNetT0Avg_VAR = (decimal)entity.ReactivePowerTotalNetT0Avg_VAR,
      ApparentPowerTotalNetT0Avg_VA = (decimal)entity.ApparentPowerTotalNetT0Avg_VA,
