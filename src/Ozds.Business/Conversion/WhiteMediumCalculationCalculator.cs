...
public class WhiteMediumCalculationCalculator : CalculationCalculator<WhiteMediumCatalogueModel>
{
  ...
  )
  {
    ...
    var initial = new WhiteMediumCalculationModel()
    {
      ...
      ActiveEnergyTotalImportT1Min_Wh = (decimal)calculationBasis.Aggregates
        .FirstOrDefault()!.ActiveEnergy_Wh.TariffBinary.T1.DuplexImport.PhaseSum,
      ...
      ActiveEnergyTotalImportT2Min_Wh = (decimal)calculationBasis.Aggregates
        .FirstOrDefault()!.ActiveEnergy_Wh.TariffBinary.T2.DuplexImport.PhaseSum,
      ...
      ActivePowerTotalImportT1Peak_W = (decimal)aggregates
        .Select(aggregate => aggregate.ActivePower_W.TariffBinary.T1.DuplexImport.PhaseSum)
        .Order()
        .FirstOrDefault(),
      ...
      ReactiveEnergyTotalImportT0Min_VARh = (decimal)calculationBasis.Aggregates
        .FirstOrDefault()!.ReactiveEnergy_VARh.TariffUnary.DuplexImport.PhaseSum,
      ...
      ReactiveEnergyTotalExportT0Min_VARh = (decimal)calculationBasis.Aggregates
        .FirstOrDefault()!.ReactiveEnergy_VARh.TariffUnary.DuplexExport.PhaseSum,
