...
public class BlueLowCalculationCalculator : CalculationCalculator<BlueLowCatalogueModel>
{
  ...
  )
  {
    ...
    var initial = new BlueLowCalculationModel()
    {
      ...
      ActiveEnergyTotalImportT0Price_EUR = catalogue.ActiveEnergyTotalImportT0Price_EUR,
