...
public class ModelCachingEntityConverter(IServiceProvider serviceProvider)
{
  ...
  private IModelCachingEntityConverter GetEntityConverterForConversion(
    Type type
  )
  {
    var converter = GetEntityConverter(type);
  ...
  private IModelCachingEntityConverter GetEntityConverter(Type type)
  {
  ...
  private IModelCachingEntityConverter GetModelConverterForConversion(Type type)
  {
    var converter = GetModelConverter(type);
  ...
  private IModelCachingEntityConverter GetModelConverter(Type type)
  {
