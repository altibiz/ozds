...
public class AbbB2xMeasurementModelReportEntityConverter(
  ...
  >(serviceProvider)
{
  ...
  )
  {
    ...
    entity.ReactivePowerL1NetT0_VAR = model.ReactivePowerL1NetT0_VAR;
    entity.ReactivePowerL2NetT0_VAR = model.ReactivePowerL2NetT0_VAR;
    entity.ReactivePowerL3NetT0_VAR = model.ReactivePowerL3NetT0_VAR;
    ...
    entity.ActiveEnergyL1ExportT0_Wh = model.ActiveEnergyL1ExportT0_Wh;
    entity.ActiveEnergyL2ExportT0_Wh = model.ActiveEnergyL2ExportT0_Wh;
    entity.ActiveEnergyL3ExportT0_Wh = model.ActiveEnergyL3ExportT0_Wh;
  ...
  )
  {
    ...
    model.ReactivePowerL1NetT0_VAR = entity.ReactivePowerL1NetT0_VAR;
    model.ReactivePowerL2NetT0_VAR = entity.ReactivePowerL2NetT0_VAR;
    model.ReactivePowerL3NetT0_VAR = entity.ReactivePowerL3NetT0_VAR;
    ...
    model.ActiveEnergyL1ExportT0_Wh = entity.ActiveEnergyL1ExportT0_Wh;
    model.ActiveEnergyL2ExportT0_Wh = entity.ActiveEnergyL2ExportT0_Wh;
    model.ActiveEnergyL3ExportT0_Wh = entity.ActiveEnergyL3ExportT0_Wh;
