  ...
  MeasurementEntity>(serviceProvider)
{
  ...
  )
  {
    ...
    model.ReactivePowerL1NetT0_VAR =
      entity.ReactivePowerL1NetT0_VAR.ToDecimal();
    model.ReactivePowerL2NetT0_VAR =
      entity.ReactivePowerL2NetT0_VAR.ToDecimal();
    model.ReactivePowerL3NetT0_VAR =
      entity.ReactivePowerL3NetT0_VAR.ToDecimal();
    ...
    model.ActiveEnergyL1ExportT0_Wh =
      entity.ActiveEnergyL1ExportT0_Wh.ToDecimal();
    model.ActiveEnergyL2ExportT0_Wh =
      entity.ActiveEnergyL2ExportT0_Wh.ToDecimal();
    model.ActiveEnergyL3ExportT0_Wh =
      entity.ActiveEnergyL3ExportT0_Wh.ToDecimal();
