...
public class AbbB2xMeasurementAggregateConverter(TimeQueries time)
  ...
  >
{
  ...
  )
  {
    ...
    aggregate.DerivedActivePowerL1ImportT0_W = new DerivedAggregateMeasureModel
    {
      Avg = 0M,
    ...
    aggregate.DerivedActivePowerL2ImportT0_W = new DerivedAggregateMeasureModel
    {
      Avg = 0M,
      Min = decimal.MaxValue,
      Max = decimal.MinValue,
    ...
    aggregate.DerivedActivePowerL3ImportT0_W = new DerivedAggregateMeasureModel
    {
      Avg = 0M,
      Min = decimal.MaxValue,
      Max = decimal.MinValue,
    ...
    aggregate.DerivedActivePowerL1ExportT0_W = new DerivedAggregateMeasureModel
    {
      Avg = 0M,
      Min = decimal.MaxValue,
      Max = decimal.MinValue,
    ...
    aggregate.DerivedActivePowerL2ExportT0_W = new DerivedAggregateMeasureModel
    {
      Avg = 0M,
      Min = decimal.MaxValue,
      Max = decimal.MinValue,
    ...
    aggregate.DerivedActivePowerL3ExportT0_W = new DerivedAggregateMeasureModel
    {
      Avg = 0M,
      Min = decimal.MaxValue,
      Max = decimal.MinValue,
