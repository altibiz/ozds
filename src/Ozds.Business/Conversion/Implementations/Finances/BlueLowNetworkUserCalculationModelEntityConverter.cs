  ...
  >(serviceProvider)
{
  ...
  )
  {
    ...
    entity.UsageActiveEnergyTotalImportT0 = model.UsageActiveEnergyTotalImportT0
      is null
      ? null!
      : modelEntityConverter.ToEntity<UsageActiveEnergyTotalImportT0CalculationItemEntity>(
    ...
    entity.ArchivedUsageNetworkUserCatalogue =
      model.ConcreteArchivedUsageNetworkUserCatalogue is null
        ? null!
        : modelEntityConverter.ToEntity<BlueLowNetworkUserCatalogueEntity>(
  ...
  )
  {
    ...
    model.UsageActiveEnergyTotalImportT0 = entity.UsageActiveEnergyTotalImportT0
      is null
      ? null!
      : modelEntityConverter.ToModel<UsageActiveEnergyTotalImportT0CalculationItemModel>(
    ...
    model.ConcreteArchivedUsageNetworkUserCatalogue =
      entity.ArchivedUsageNetworkUserCatalogue is null
        ? null!
        : modelEntityConverter.ToModel<BlueLowNetworkUserCatalogueModel>(
          entity.ArchivedUsageNetworkUserCatalogue
        );
  }
}
