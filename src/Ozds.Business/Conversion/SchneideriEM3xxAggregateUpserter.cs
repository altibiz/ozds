...
public class SchneideriEM3xxxAggregateUpserter : AggregateUpserter<SchneideriEM3xxxAggregateModel, SchneideriEM3xxxAggregateEntity>
{
  protected override SchneideriEM3xxxAggregateModel UpsertConcreteModel(SchneideriEM3xxxAggregateModel lhs, SchneideriEM3xxxAggregateModel rhs) =>
    new()
    {
      MeterId = lhs.MeterId,
  ...
  protected override Expression<Func<SchneideriEM3xxxAggregateEntity, SchneideriEM3xxxAggregateEntity, SchneideriEM3xxxAggregateEntity>> UpsertConcreteEntity =>
    (lhs, rhs) => new()
    {
      MeterId = lhs.MeterId,
      Timestamp = lhs.Timestamp,
