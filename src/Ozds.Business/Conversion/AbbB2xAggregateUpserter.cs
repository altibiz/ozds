...
public class AbbB2xAggregateUpserter : AggregateUpserter<AbbB2xAggregateModel, AbbB2xAggregateEntity>
{
  protected override AbbB2xAggregateModel UpsertConcreteModel(AbbB2xAggregateModel lhs, AbbB2xAggregateModel rhs) =>
    new()
    {
      MeterId = lhs.MeterId,
  ...
  protected override Expression<Func<AbbB2xAggregateEntity, AbbB2xAggregateEntity, AbbB2xAggregateEntity>> UpsertConcreteEntity =>
    (lhs, rhs) => new()
    {
      MeterId = lhs.MeterId,
      Timestamp = lhs.Timestamp,
